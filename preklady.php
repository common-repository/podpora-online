<h2>Překlady pro WordPress</h2>
  
<div class="postbox gdrgrid frontleft">
        <small style="float: right; margin-right:6px; margin-top:6px;">
        <a target="_blank" href="http://wptranslations.eu/prispevky/">Zobrazit všchny překlady</a> | <a href="http://wptranslations.eu/kategorie/preklady-vse/feed/" target="_blank">RSS</a></small>
        <h3 class="hndle"><span>Posledních 10 překladů pro WordPress</span></h3>
        <div class="gdsrclear"></div>
    <div class="inside">
        <?php

        if ($options['news_feed_active'] == 0) {
            $feed = fetch_feed('http://wptranslations.eu/kategorie/preklady-vse/feed/');
                if (!is_wp_error( $feed )) {
